...
accessible method net/minecraft/world/entity/Entity applyMovementEmissionAndPlaySound (Lnet/minecraft/world/entity/Entity$MovementEmission;Lnet/minecraft/world/phys/Vec3;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/block/state/BlockState;)V
...
accessible method net/minecraft/world/entity/Entity axisStepOrder (Lnet/minecraft/world/phys/Vec3;)Ljava/lang/Iterable;

accessible class net/minecraft/world/entity/Entity$Movement

accessible field net/minecraft/world/entity/Mob lootTable Ljava/util/Optional;